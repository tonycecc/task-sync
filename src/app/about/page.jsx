export default async function AboutPage() {
  return (
    <div className="size-fit bg-[#F9E9EC] flex flex-col font-arial text-[#577590]">
      <p className="mx-8 my-4 text-2xl text-center font-bold">Who We Are
      </p>
      ...
      <p className="mx-8 my-4 text-left"> Anyway, we hope you and your team can get some use out of this project. 
      </p>
      ...
      <p className="mx-8 my-6 text-left">p.s. Thank you to our instructor, Asaad Althoubi, for helping us out along the way.
      </p>
    </div>
  );
}
